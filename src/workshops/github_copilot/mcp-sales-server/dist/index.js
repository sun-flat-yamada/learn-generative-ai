...
// [Role] 製品別の売上を集計するツール
server.tool("get_product_sales", { product: z.string().describe("製品名 (例: Laptop Pro 14)") }, async ({ product }) => {
    /**
...
server.tool("search_feedback", { keyword: z.string().describe("検索キーワード") }, async ({ keyword }) => {
    /**
